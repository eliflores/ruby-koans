...
class AboutSymbols < Neo::Koan
  ...
  # Because :test_method_names_become_symbols in the comparison will create it,
  # so the comparison will always be true. By converting all_symbols to strings
  # and comparing strings, we can distinguish whether the symbol existed prior
  # to the comparison.
