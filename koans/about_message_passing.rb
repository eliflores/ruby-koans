...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # own send method which has nothing to do with Object#send. So if you want
    # to work with objects of any class, you need to use __send__ to be on the
    # safe side.
    # Why there is send and not just __send__ ?
    # Send existed first and only later it was realized that the name send might
    # also usefully be used in other contexts, so __send__ was added.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # The method would behave according to the new definition of
    # method_missing.
    #
    # NOTE:
    #
