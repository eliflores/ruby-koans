...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # Never? It will always give the emtpy string?
  end
  ...
  #
  # Why?
  # Because they try to match as much as possible in a string, i.e. matching the longest possible string
  # ------------------------------------------------------------------
  ...
  # Character classes are designed to match one of the included characters.
  # E.g. [abc] will be applied in a single step of the regex engine: "Is the next
  # character one of a, b, or c?"
  # Whereas (a|b|c) tells the regex engine to remember the current position in
  # the string for backtracking and then checks if it's possible to match each
  # character, backtracking each time until it's matched, once all the characters
  # have been tried, give it up.
