...
class AboutClassMethods < Neo::Koan
  ...
  # I prefer the second one, specially if I have various class methods, I like having a place
  # where all the class methods are defined and are easy to find.
  # Are there times you might prefer one over the other?
  # I may prefer the first one when there is only one class method.
